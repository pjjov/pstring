...
/** Module: Core functions for interacting with pstrings
...
#ifndef PSTR_NORETURN
    #define PSTR_NORETURN
#endif
...
/** These macros emit an exception with the given error code and message. */
