...
static int test_pstring_compare(int seed, int repetitition) {
    ...
    pf_assert_true(pstrprefix(&a, "Hello", 0));
    pf_assert_true(pstrsuffix(&a, "world!", 0));
    pf_assert_false(pstrprefix(&a, "Hello ", 0));
    pf_assert_false(pstrsuffix(&a, "world", 0));
...
const pf_test_t suite_pstring[] = {
    { test_pstring_new, "/pstring/new" },
    { test_pstring_alloc, "/pstring/alloc" },
    { test_pstring_wrap_slice, "/pstring/wrap_slice" },
    { test_pstring_resize, "/pstring/resize" },
    { test_pstring_compare, "/pstring/compare" },
    { test_pstring_concat, "/pstring/concat" },
    { test_pstring_join, "/pstring/join" },
    { test_pstring_copy, "/pstring/copy" },
    { test_pstring_chr, "/pstring/chr" },
    { test_pstring_span, "/pstring/span" },
    { test_pstring_breakset, "/pstring/breakset" },
    { test_pstring_strip, "/pstring/strip" },
    { test_pstring_substring, "/pstring/substring" },
    { test_pstring_replace, "/pstring/replace" },
    { test_pstring_split, "/pstring/split" },
    { test_pstring_insert_remove, "/pstring/insert_remove" },
    { test_pstring_indent, "/pstring/indent" },
    { test_pstring_distance, "/pstring/distance" },
    { 0 },
};
